                ...
                {filteredChats.map(chat => (
                  ...
                  >
                    <div className="relative">
                      ...
                      {chat.unreadCount ? (
                        <span className="absolute -top-1 -right-1 h-4 w-4 bg-primary text-white text-[10px] flex items-center justify-center rounded-full border-2 border-white animate-pulse">
                          {chat.unreadCount}
                        </span>
                      ) : null}
                    </div>
