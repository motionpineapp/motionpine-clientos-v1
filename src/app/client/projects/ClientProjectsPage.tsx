...
import { Calendar, Clock, ArrowRight, CheckCircle2, Loader2, AlertCircle } from 'lucide-react';
      ...
      {projects.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {projects.map((project) => (
            <Card key={project.id} className="border-gray-100 shadow-sm hover:shadow-md transition-all group flex flex-col">
              ...
              <CardContent className="flex-1 flex flex-col justify-end space-y-6">
                {/* Progress Section (Mocked based on status) */}
