...
export function IntakePage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10 lg:py-12">
      <div className="space-y-6 animate-fade-in h-[calc(100vh-180px)] flex flex-col">
        <PageHeader
          ...
          <CardContent className="p-0 h-full">
            <div className="w-full h-full bg-gray-50 flex flex-col items-center justify-center text-center p-8">
              <div className="max-w-md space-y-6">
                <div className="h-16 w-16 bg-white rounded-2xl shadow-sm mx-auto flex items-center justify-center animate-float">
                ...
                <div className="p-6 bg-white rounded-xl border border-gray-200 text-left space-y-4 shadow-sm">
                  ...
                  <div className="h-10 w-full bg-primary/10 rounded border border-primary/20 flex items-center justify-center text-primary font-medium hover:bg-primary/20 transition-colors cursor-pointer">
                    Submit Request
                  </div>
                </div>
              </div>
